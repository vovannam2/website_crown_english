...
export default function Footer() {
  ...
  return <footer className="mt-auto border-t border-[var(--color-line)] bg-[var(--color-ink)] text-white"><Container><div className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-[1.35fr_1fr_1fr_1.25fr]">
    <div><Link href="/" className="footer-brand mb-5 inline-flex items-center gap-5" aria-label="Crown English - Trang chủ"><Image src="/logo/logoKhongChu.png" alt="" width={164} height={116} className="h-[116px] w-[164px] shrink-0 object-contain" /><span className="flex flex-col leading-none"><span className="footer-brand-crown">CROWN</span><span className="footer-brand-english">ENGLISH</span></span></Link><p className="max-w-xs text-[15px] leading-7 text-white/70">{siteConfig.shortDescription}</p></div>
