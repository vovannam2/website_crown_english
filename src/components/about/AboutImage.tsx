...
import type { AboutImageSlot } from "@/data/about";
...
export default function AboutImage({ image, className = "", sizes, preload = false }: {
  ...
  return <Reveal delay={preload ? 100 : 0} className={`${styles.imageFrame} ${className}`}>
